...
const CharacterDetails: React.FC<CharacterDetailsProps> = ({
  ...
  useEffect(() => {
      ...
      if (heightStr.includes("cm") || heightStr.includes("CM")) {
        ...
        if (feetMatch && inchesMatch) {
          const cm = feetInchesToCm(
            parseInt(feetMatch[1]),
            parseInt(inchesMatch[1]),
          );
    ...
    if (characterData.weight) {
      ...
      if (weightStr.includes("kg") || weightStr.includes("KG")) {
        ...
        weightStr.includes("lbs") ||
        weightStr.includes("lb") ||
        !weightStr.includes("kg")
      ) {
  ...
  const handleFillRandomFields = () => {
    ...
    if (heightUnit === "ft") {
      ...
      setHeightCm(
        Math.round(
          (randomHeight.feet * 12 + randomHeight.inches) * 2.54,
        ).toString(),
      );
    } else {
  ...
  return (
    <div className="p-8 font-sans bg-parchment min-h-full">
      ...
      <p className="text-center text-chestnut mb-6">
        Fill in the final details of your character.
      </p>
      ...
      <div className="max-w-md mx-auto bg-parchment-light p-6 rounded-lg border-2 border-saddle-brown">
        <div className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-ink mb-2">
              Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="age" className="block text-ink mb-2">
              Age
            </label>
            <input
              type="text"

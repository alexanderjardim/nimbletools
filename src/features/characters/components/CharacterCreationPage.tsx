...
const CharacterCreationPage: React.FC<CharacterCreationPageProps> = ({
  ...
  useEffect(() => {
    console.log(
      "CharacterCreationPage useEffect - resumeData changed:",
      resumeData,
    );
    if (resumeData) {
  ...
  const updateCharacterData = (newData: Record<string, any>) => {
    ...
    console.log(
      "CharacterCreationPage updateCharacterData - previous characterData:",
      characterData,
    );
    setCharacterData((prev) => {
      ...
      console.log(
        "CharacterCreationPage updateCharacterData - new characterData:",
        updated,
      );
      return updated;
    });
  ...
  const updateCharacterDataOnly = (newData: Record<string, any>) => {
    console.log(
      "CharacterCreationPage updateCharacterDataOnly called:",
      newData,
    );
    console.log(
      "CharacterCreationPage updateCharacterDataOnly - previous characterData:",
      characterData,
    );
    setCharacterData((prev) => {
      const updated = {
      ...
      console.log(
        "CharacterCreationPage updateCharacterDataOnly - new characterData:",
        updated,
      );
      return updated;
    });
  ...
  const renderStep = () => {
    console.log(
      "CharacterCreationPage renderStep - Current step:",
      step,
      "characterData:",
      characterData,
    );
    switch (step) {
      case 1:
        ...
        return (
          <ChooseClass
            onNext={(data) => {
              console.log(
                "CharacterCreationPage - ChooseClass onNext called:",
                data,
              );
      ...
      case 2:
        ...
        return (
          <ChooseAncestry
            onNext={(data) => {
              console.log(
                "CharacterCreationPage - ChooseAncestry onNext called:",
                data,
              );
            ...
            onBack={() => {
              console.log(
                "CharacterCreationPage - ChooseAncestry onBack called",
              );
              prevStep();
            }}
          />
      ...
      case 3:
        ...
        return (
          <ChooseBackground
            onNext={(data) => {
              console.log(
                "CharacterCreationPage - ChooseBackground onNext called:",
                data,
              );
            ...
            onBack={() => {
              console.log(
                "CharacterCreationPage - ChooseBackground onBack called",
              );
              prevStep();
            }}
          />
      ...
      case 4:
        ...
        return (
          <AssignStats
            onNext={(data) => {
              console.log(
                "CharacterCreationPage - AssignStats onNext called:",
                data,
              );
      ...
      case 5:
        ...
        return (
          <AssignSkills
            onNext={(data) => {
              console.log(
                "CharacterCreationPage - AssignSkills onNext called:",
                data,
              );
      ...
      case 6:
        ...
        return (
          <CharacterDetails
            ...
            onComplete={() => {
              console.log(
                "CharacterCreationPage - CharacterDetails onComplete called",
              );
              nextStep();
            }}
            onUpdate={(data) => {
              console.log(
                "CharacterCreationPage - CharacterDetails onUpdate called:",
                data,
              );
            ...
            onBack={() => {
              console.log(
                "CharacterCreationPage - CharacterDetails onBack called",
              );
              prevStep();
            }}
          />
      ...
      case 7:
        console.log("CharacterCreationPage Debug - Step 7:", {
          characterData,
          step,
        });
        return (
          <CharacterReview
            ...
            onComplete={() => {
              console.log(
                "CharacterCreationPage - CharacterReview onComplete called",
              );
              handleCharacterCreationComplete();
            }}
            onBack={() => {
              console.log(
                "CharacterCreationPage - CharacterReview onBack called",
              );
              prevStep();
            }}
            onNavigateToStep={(stepNum) => {
              console.log(
                "CharacterCreationPage - CharacterReview onNavigateToStep called:",
                stepNum,
              );
              goToStep(stepNum);
            }}

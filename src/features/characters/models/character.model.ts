import { Size, SKILL_STATS, SkillName, StatName } from '../../../shared/constants/character.constants';
...
export class Character {
    ...
    private calculateSkills(skillPoints: Map<string, number>): { [key in SkillName]: number } {
        ...
        for (const skillName of Object.keys(SKILL_STATS) as SkillName[]) {
            ...
            if (total > 12) {
                throw new Error(`Skill ${skillName} total (stat + points) cannot exceed 12.`);
            }

...
export const backgroundsData: IBackgroundData[] = [
  {
    ...
    name: "Acolyte",
    description:
      "You have spent your life in service to a temple, dedicated to a specific deity or pantheon of gods.",
    teasers: [
  ...
  },
  {
    ...
    name: "Artisan",
    description:
      "You come from a family or community of skilled craftspeople, trained in a specific trade or craft.",
    teasers: [
  ...
  },
  {
    ...
    name: "Charlatan",
    description:
      "You have a history of deception, using wit and charm to manipulate situations to your advantage.",
    teasers: [
  ...
  },
  {
    ...
    name: "Criminal",
    description:
      "You have a past in the criminal underworld, with connections and skills developed through illicit activities.",
    teasers: [
  ...
  },
  {
    ...
    name: "Entertainer",
    description:
      "You have made your living through performance, whether as a musician, actor, dancer, or other type of artist.",
    teasers: [
      "Skilled performer",
  ...
  },
  {
    ...
    name: "Folk Hero",
    description:
      "You come from humble origins but have become a local hero, known for standing up for the common people.",
    teasers: [
  ...
  },
  {
    ...
    name: "Noble",
    description:
      "You were born into a noble family, with a privileged upbringing and access to education and resources.",
    teasers: [
  ...
  },
  {
    ...
    name: "Sage",
    description:
      "You have dedicated your life to scholarly pursuits, with extensive knowledge in various academic fields.",
    teasers: [
  ...
  },
  {
    ...
    name: "Soldier",
    description:
      "You have served in a military organization, trained in combat and disciplined in military tactics.",
    teasers: [
      "Military training",
